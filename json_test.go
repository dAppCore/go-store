...
func TestJson_RawMessage_MarshalJSON_Good(t *T) {
...
func TestJson_RawMessage_MarshalJSON_Bad(t *T) {
...
func TestJson_RawMessage_MarshalJSON_Ugly(t *T) {
...
func TestJson_RawMessage_UnmarshalJSON_Good(t *T) {
...
func TestJson_RawMessage_UnmarshalJSON_Bad(t *T) {
	var raw *store.RawMessage
	err := raw.UnmarshalJSON([]byte(`{"name":"alice"}`))
	AssertError(t, err)
	AssertNil(t, raw)
...
func TestJson_RawMessage_UnmarshalJSON_Ugly(t *T) {
