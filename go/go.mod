...
require (
	...
	github.com/klauspost/compress v1.19.1 // Note: compression codecs for storage payloads; no core equivalent
	modernc.org/sqlite v1.55.0 // Note: pure-Go SQLite driver; no core equivalent
)
